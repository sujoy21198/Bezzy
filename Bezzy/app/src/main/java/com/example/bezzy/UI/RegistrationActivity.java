...
public class RegistrationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    public void Register() {
        if(ed_username.getText().toString().isEmpty()){
            ...
            if(Utility.internet_check(RegistrationActivity.this)) {
                progressDialog.show();
                callApiRegistration(APIs.BASE_URL+APIs.REGISTRATION);
            }
            else {
                progressDialog.dismiss();
                Toast.makeText(RegistrationActivity.this,"No Network!",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void callApiRegistration(String url) {
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(object.getString("resp").equals("true")){
                        progressDialog.dismiss();
                        Toast.makeText(RegistrationActivity.this,object.getString("reg_msg"),Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(RegistrationActivity.this,OTPActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        Utility.setOtpScreen(RegistrationActivity.this,"1");
                        Utility.setUserId(RegistrationActivity.this,object.getString("log_userID"));
                    }else{
                        progressDialog.dismiss();
                        Toast.makeText(RegistrationActivity.this,object.getString("reg_msg"),Toast.LENGTH_SHORT).show();
                    }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("password",ed_email.getText().toString());
                map.put("dob",ed_email.getText().toString());
                map.put("gender",ed_email.getText().toString());
                return map;
            }
        };
